...
use OC\UserBundle\Entity\Company;
...
class CompanyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $companies = $em->getRepository('OCUserBundle:Company')->findAll();
    ...
    {
        $company = new Company();
        $form = $this->createForm('OC\UserBundle\Form\CompanyType', $company);
    ...
    {
        $deleteForm = $this->createDeleteForm($company);
        $editForm = $this->createForm('OC\UserBundle\Form\CompanyType', $company);
