...
use OC\UserBundle\Entity\Categories;
...
class CategoriesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categories = $em->getRepository('OCUserBundle:Categories')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('OC\UserBundle\Form\CategoriesType', $category);
    ...
    {
        $deleteForm = $this->createDeleteForm($category);
        $editForm = $this->createForm('OC\UserBundle\Form\CategoriesType', $category);
